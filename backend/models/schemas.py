...
class CaseStatus(str, Enum):
    OPEN='OPEN'; INVESTIGATING='INVESTIGATING'; AWAITING_EVIDENCE='AWAITING_EVIDENCE'; PENDING_APPROVAL='PENDING_APPROVAL'; ACTION_RECOMMENDED='ACTION_RECOMMENDED'; ACTION_EXECUTED='ACTION_EXECUTED'; ESCALATED='ESCALATED'; RESOLVED='RESOLVED'; CLOSED='CLOSED'
